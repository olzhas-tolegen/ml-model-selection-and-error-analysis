...
| `02-neural-training-optimization-and-stability` | In progress | Study optimizer behavior, regularization, seed stability, compute budgets, and neural-network training dynamics |
